...
csv_list=/opt/podman/daily_stud_db/csv_list
#mysql_home
#mysql_dir=/home/mysql/mysql_pass
mysql_dir=/opt/podman/daily_stud_db
...
mount -t cifs -o credentials=/root/credential //sstu-deps.sstudepsdom/uit/ois/Temp $mnt_dir -o ro $2 >> "$mnt_log"
